...
/***/ function(module, exports, __webpack_require__) {
	...
	var crudEvents = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ui = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./ui\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	var getFormFields = __webpack_require__(8);

	var onSignUp = function onSignUp(e) {
	  e.preventDefault();
	  var data = getFormFields(this);
	  api.signUp(data).then(function (responseData) {
	    ui.signUpSuccess(responseData);
	    return api.signIn(data);
	  }).then(ui.signInSuccess).catch(ui.authFailure);
	};

	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.signIn(data).then(ui.signInSuccess).catch(ui.authFailure);
	};

	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.signOut(data).then(ui.signOutSuccess).catch(ui.authFailure);
	};

	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.changePassword(data).then(ui.changePasswordSuccess).catch(ui.authFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateGame = function onCreateGame(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.createGame(data).then(ui.createGameSuccess).catch(ui.failure);
	};
	...
	var onUpdateGame = function onUpdateGame(event) {
	  ...
	  api.updateGame(data, current).then(ui.updateGameSuccess).catch(ui.failure);
	};
	...
	module.exports = {
	  addCrudHandlers: addCrudHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vault = __webpack_require__(6);
	var getGames = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class=\"show-games\">\n  <div class=\"hb-id\">\n    Game ID: "
	    ...
	    + "\n  </div>\n  <div class=\"hb-lvl\">\n    Level: "
	    + alias4(((helper = (helper = helpers.lvl || (depth0 != null ? depth0.lvl : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"lvl","hash":{},"data":data}) : helper)))
	    + "\n  </div>\n  <div class=\"hb-score\">\n    Score: "
